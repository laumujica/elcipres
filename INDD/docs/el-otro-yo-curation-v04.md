# El otro yo
## Curaduría editorial v04 · revisión ortotipográfica y estructural

**Selección:** 90 piezas · **Orden:** cronológico estricto · **Texto:** sin reescritura

### Convención estructural

- Una línea en blanco indica un **cambio de párrafo o de estrofa real**.
- Dos espacios al final de una línea indican un **salto de línea interno e intencional** dentro de la misma unidad.
- La **continuidad** de una oración o párrafo se mantiene sin cortes artificiales de línea.
- Los comentarios `ELCIPRES:EDITORIAL_QUERY` señalan únicamente casos de duda conservados como en la fuente. No forman parte de la obra y deben retirarse antes de la composición final.

### Criterio de intervención

Esta versión conserva íntegramente la voz, la sintaxis, el vocabulario, las repeticiones, las imágenes y las decisiones expresivas del autor. Se corrigieron errores ortográficos y ortotipográficos inequívocos, incluidos signos de puntuación, mayúsculas, vocativos, diálogos y espacios. No se normalizaron giros coloquiales, concordancias, puntuación rítmica ni construcciones que pudieran pertenecer a su modo de escribir. Ante cualquier duda, se mantuvo el original.

Los saltos de línea claramente intencionales fueron conservados, especialmente en poemas, estructuras rítmicas y composiciones visuales. Los cortes atribuibles a la carga del blog fueron normalizados sin modificar palabras, signos ni orden textual. Cuando una línea cerraba además un párrafo o una estrofa, se dejó únicamente la marca de párrafo para evitar una doble instrucción estructural.

### Resultado de la cuarta lectura

La selección de 90 piezas y los cinco movimientos quedan confirmados. No se incorporaron textos de reserva ni se retiraron piezas. Esta pasada completa la revisión ortotipográfica y ajusta únicamente los saltos cuya clasificación estructural resulta inequívoca.

### Reglas de paginación para automatización

Cada movimiento comienza con una portada interna en página derecha (recto), sin folio visible. El dorso inmediato (verso) queda completamente en blanco y también sin folio visible. El primer texto del movimiento comienza en la página derecha siguiente.

Las portadas y sus dorsos ocupan páginas físicas y conservan la secuencia del documento, aunque el número no se imprima. Los cinco movimientos agregan así diez páginas físicas: cinco portadas y cinco dorsos blancos.

Los comentarios `ELCIPRES` son directivas de composición: el script debe interpretarlos y retirarlos antes de volcar el contenido textual en InDesign.

---

<!-- ELCIPRES:SECTION_COVER id="movement-01" start_on="recto" show_folio="false" count_in_sequence="true" -->
# I · Inventario de una vida

*31 de agosto de 2008 — 3 de febrero de 2009*

<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:BLANK_PAGE side="verso" show_folio="false" count_in_sequence="true" -->
<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:SECTION_BODY id="movement-01" start_on="recto" -->
...
Fui coescritor de libros de vidas que míos no fueron,  
...
Único espectador, ¡qué privilegio!
...
en la monotonía de textos remanidos, sin brillos,  
y en la uniformidad de colores, negro desteñido.

La saga es larga y ya va por el enésimo;  
...
del país que me cobijó por el tiempo de mi huida;  
...
<!-- ELCIPRES:TEXT_TYPE hybrid -->

<!-- ELCIPRES:BLOCK type="prose" -->
...
él era la viva esperanza a cuestas,  
...
Chaco, Argentina, un millón de habitantes; centro habitacional permanente de la miseria; 50 % pobreza, 40 % indigencia, 20 % mortalidad infantil (niños fallecidos antes de cumplir un año de vida). Un pueblo olvidado dentro de un gran olvido nacional. Un pueblo donde el hambre se muere de hambre; en un país banquete donde pocos son los que comen (rapiñan).
...
<!-- ELCIPRES:SECTION_COVER id="movement-02" start_on="recto" show_folio="false" count_in_sequence="true" -->
# II · La noche aprende a hablar

*24 de marzo — 30 de diciembre de 2009*

<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:BLANK_PAGE side="verso" show_folio="false" count_in_sequence="true" -->
<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:SECTION_BODY id="movement-02" start_on="recto" -->
...
equivalentes a ser nadie en sí mismo.
...
Este cuerpo es lo único que tengo;  
vacío de futuro,  
...
<!-- ELCIPRES:SECTION_COVER id="movement-03" start_on="recto" show_folio="false" count_in_sequence="true" -->
# III · Daniel, un hombre extraño

*1 de enero — 31 de julio de 2010*

<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:BLANK_PAGE side="verso" show_folio="false" count_in_sequence="true" -->
<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:SECTION_BODY id="movement-03" start_on="recto" -->
...
Son los pasos abandonados en la huida,  
...
Retomo las páginas con versos remanidos  
...
de los autolímites que masifican  
...
<!-- ELCIPRES:SECTION_COVER id="movement-04" start_on="recto" show_folio="false" count_in_sequence="true" -->
# IV · Formas breves de seguir

*1 de agosto — 6 de diciembre de 2010*

<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:BLANK_PAGE side="verso" show_folio="false" count_in_sequence="true" -->
<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:SECTION_BODY id="movement-04" start_on="recto" -->
...
<!-- ELCIPRES:TEXT_TYPE visual -->

<!-- ELCIPRES:KEEP_TOGETHER true -->
...
en un chárter urbano camino al consumismo;  
...
<!-- ELCIPRES:SECTION_COVER id="movement-05" start_on="recto" show_folio="false" count_in_sequence="true" -->
# V · Persistir en el círculo

*24 de marzo de 2011 — 17 de abril de 2015*

<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:BLANK_PAGE side="verso" show_folio="false" count_in_sequence="true" -->
<!-- ELCIPRES:PAGE_BREAK -->
<!-- ELCIPRES:SECTION_BODY id="movement-05" start_on="recto" -->
...
Vi cómo se estrellaba torpemente sobre una mata espinosa;  
...
Tacto buscando quién sabe qué en la memoria  
...
Veo cómo los malos ejemplos cunden  
